...
/*
Plugin Name: FAQ
Plugin URI: http://letslinc.com/faq/
Description: This is Frequently Asked Questions plugin.
Author: Son Mai
Version: 1.0
Author URI: http://twitter.com/tungson_mai
*/
...
function create_custom_post_type()
{
    ...
    register_post_type('faq', $args); //Tạo post type với slug tên là sanpham và các tham số trong biến $args ở trên
